...
function DragResize(myName, config) {
  var props = {
    ...
    minLeft: 0,
    maxLeft: 9999, // Bounding box area, in pixels.
    minTop: 0,
    maxTop: 9999,
    gridX: 1,
    gridY: 1, // Grid granularity.
...
DragResize.prototype.resizeHandleDrag = function (diffX, diffY) {
  with (this) {
    ...
    var hClass =
      handle && handle.className && handle.className.match(new RegExp(myName + "-([tmblr]{2})")) ? RegExp.$1 : "";
...
function initDragResize() {
  /*gets view hidth and width to bound windows */
  var viewportwidth;
  var viewportheight;
  ...
  var dragresize = new DragResize("dragresize", {
    ...
    minLeft: 0,
    minTop: 0,
    maxLeft: viewportwidth - 4,
    maxTop: viewportheight - 36,
  });
  ...
  //  gridX, gridY: Size of the grid to which elements align (in pixels, default 1).

  // Next, you must define two functions, isElement and isHandle. These are passed
  // a given DOM element, and must "return true" if the element in question is a
  // draggable element or draggable handle. Here, I'm checking for the CSS classname
  // of the elements, but you can have any combination of conditions you like:
  ...
  // Within, use this.element for the dragged element and this.handle for the handle.
